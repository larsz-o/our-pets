...
class MedicationsReport extends Component {
  constructor(){
    super();
    this.state = {
      date: '01-01-2018',
  ...
  sendReportToDatabase = () => {
    console.log('in send medications report to database');
    axios({
      method: 'POST', 
      url: '/api/activities', 
      data: this.state
      ...
      content = (
        <div>
          ...
          <form>
              ...
              <Input onChange={this.handleInputChangeFor('medication_name')} type="text"/>
              <br/>
              <InputLabel>Notes: </InputLabel>
              <TextField onChange={this.handleInputChangeFor('notes')}/><br/>
...
export default connect(mapStateToProps)(MedicationsReport); 